...
(
    ...
    total_solar_radiation_mj_m2					NVARCHAR(100) NULL,
    ...
    weighted_average_soil_moisture_0_100cm      NVARCHAR(100) NULL,
    weighted_average_soil_temperature_7_100cm	NVARCHAR(100) NULL,
